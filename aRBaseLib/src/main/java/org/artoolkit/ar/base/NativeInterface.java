...
public class NativeInterface {
    ...
    public static native int arwNftAddMarker(byte[] image);

    public static native boolean arwNftTryCreateMarkerFromeImage(byte[] image);

    public static native void arwNftSaveMarker(int markerUID,String path);
